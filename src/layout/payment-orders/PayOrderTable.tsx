...
const PayOrderTable = ({ orders }: TableProps) => {
    ...
    <>
      ...
      <tr className="bg-white  text-brand_black-500 font-Montserrat whitespace-nowrap text-sm font-semibold">
        ...
        <td className="px-4 py-3 ">
          <ProductSection city={item.seller.city} product={item.product} />
        </td>
        <td className="px-4 py-3 text-center">
...
const ProductSection = ({ product, city }: ProductProps) => {
  return (
